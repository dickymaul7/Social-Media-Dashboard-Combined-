...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body><ActiveBrandProvider><BrandIntelligenceProvider><AuthGuard><WorkspaceHydrator/>{children}<BrandAlignmentWidget/><TaskAssignmentWidget/><BufferInstagramPublisher/><CalendarTaskAssignment/><CalendarLegacyDesignLinkHider/></AuthGuard></BrandIntelligenceProvider></ActiveBrandProvider></body></html>}