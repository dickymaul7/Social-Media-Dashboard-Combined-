...
import {
  BarChart3, CalendarDays, ChevronDown, FileText, Gauge, Instagram,
  LayoutDashboard, Megaphone, Menu, Search, Settings, Users, X
} from "lucide-react";

type Section = "Overview" | "Content Performance" | "Audience Analytics" | "Posting Schedule" | "Competitor Benchmarking" | "Content Calendar" | "Workspace Hub" | "Reports";
  ...
  return <main className="app-shell">
    ...
    <section className="content">
      ...
      <div className="page">
        ...
        {active==="Overview" ? <><div className="metric-grid">{cards.map(c=><div className="metric" key={c[0]}><span>{c[0]}</span><strong>{c[1]}</strong><em>{c[2]}</em></div>)}</div>
